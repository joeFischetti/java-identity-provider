...
/** test for {@link net.shibboleth.idp.attribute.resolver.ad.impl.DecryptedAttributeDefinition}. */
public class DecryptedAttributeTest {
    ...
    @Test public void both() throws ComponentInitializationException {
        ...
        decrypted.setAttributeDependencies(Collections.singleton(
